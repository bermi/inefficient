...
module.exports = (req, res) => {
  const {
    // How many should the RAM be increased on every call?
    mbPerCall = 25,
    // How much memory we want to take before stopping the memory leak?
    memory = 800,
  ...
  res.send({
    currentMemory,
    totalMemory: Math.ceil(os.totalmem() / 1024 / 1024),
    freeMemory: Math.ceil(os.freemem() / 1024 / 1024)
  });
};